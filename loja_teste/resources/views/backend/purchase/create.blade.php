                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="purchaseInputSearchProductBarcodeQtd"
                                    id="purchaseInputSearchProductBarcodeQtd" placeholder="Quantidade de Produtos" required>
                            </div>
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="purchaseInputSerachProductBarcode"
                                        name="barcodeSearch" placeholder="Código de Barras" required minlength="20"
                                        maxlength="20">
            ...
            $("#searchProductsByBarcode").click(function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        $("#productsList").removeAttr("hidden");
                        ...
                        tableProduct.row.add([
                            ...
                            amountProduct + ' /><span class="productAmout">' + amountProduct + '</span></td>',
