<div>
    ...
    @endif
    <div class="relative">
        <div class="flex py-3 justify-between items-center mb-1">
            <div class="flex-grow h-10 flex items-center">
                ...
                <div class="w-96 flex rounded-lg shadow-sm">
                    ...
                    <div class="relative flex-grow focus-within:z-10">
                        ...
                        <input wire:model.debounce.500ms="search" class="form-input block bg-gray-50 focus:bg-white w-full rounded-md pl-10 py-3 transition ease-in-out duration-150 sm:text-sm sm:leading-5" placeholder="{{__('Pesquisar por')}} {{ $this->searchableColumns()->map->label->join(', ') }}" />
                ...
                <div class="table align-middle min-w-full">
                    ...
                    @empty
                        <p class="p-3 text-lg text-teal-600">
                            {{ __("Não encontrado na base de dados!") }}
                        </p>
                    @endforelse
                </div>
            </div>
