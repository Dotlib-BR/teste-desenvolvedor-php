...
<div class="antialiased sans-serif min-h-screen bg-white" style="min-height: 900px">
	...
	<div class="container mx-auto py-6 px-4 dark:bg-darker" >
		<div class="flex justify-between">
            ...
            @if(!isset($editar))       <h2><span class="inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-indigo-100 bg-indigo-700 rounded">PEDIDO EM PROCESSAMENTO</span></h2> @endif
            <div class="block">
