...
@section('title', 'Admin - Register User')
@section('content')

<section class="container">
        <h3 class="card-title h3">Register a User</h3>
        <div class="row">
            ...
            @endif
            <div class="col-md-6">
                <form action="{{ route('registerUserAdminAction') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div>
                    ...
                    <div>
                        ...
                        <input class="form-control" id="last" type="text" name="last_name" value="{{ old('last_name') }}"
                    ...
                    <div>
                        ...
                        <input id="cpf" class="form-control cpf" type="text" name="document" value="{{ old('document')}}" placeholder="CPF">
