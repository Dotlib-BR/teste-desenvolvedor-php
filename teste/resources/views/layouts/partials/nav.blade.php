@auth
    <div id="navbarHeader">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="{{ auth()->check() ? route('dashboard.home.index') : url('/') }}">{{ config('app.name', 'Dot.Lib') }}</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item {{ setActive(['dashboard/home*']) }}">
                        <a class="nav-link" href="{{ route('dashboard.home.index') }}">Home</a>
                    </li>
                    ...
                    <li class="nav-item {{ setActive(['dashboard/purchases*']) }}">
                        <a class="nav-link" href="{{ route('dashboard.purchases.index') }}">Compra</a>
                    </li>
                </ul>
