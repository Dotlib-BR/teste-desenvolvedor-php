            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 flex flex-col">
                    <div class="w-full flex flex-row-reverse mb-2.5">
                        <a class="bg-blue-500 hover:bg-blue-600 px-3 py-2 rounded text-white focus:outline-none">Criar novo Produto</a>
                    </div>
                    <table class="table-auto rounded border-b border-gray-200 min-w-full">
                        ...
                        <tbody>
                          ...
                          @empty
                            <tr>
                                <td class="text-center" colspan="4">Sem Producs cadastrados</td>
                            </tr>
                          @endforelse
                        </tbody>
                      </table>
