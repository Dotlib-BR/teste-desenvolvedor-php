    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card border-primary mb-3">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('dashboard.empresa.vagas.update', $vaga->id) }}">
                        @csrf
                        @method('PATCH')
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-3 col-md-3">
                                        ...
                                        <div class="col-md-12">
                                            <select name="nivel" id="nivel" class="form-control @error('nivel') is-invalid @enderror" required>
                                                ...
                                                <option value="junior" {{ $vaga->nivel == 'junior' ? 'selected' : ''}}>Junior</option>
                                                <option value="pleno" {{ $vaga->nivel == 'pleno' ? 'selected' : ''}}>Pleno</option>
                                                <option value="senior" {{ $vaga->nivel == 'senior' ? 'selected' : ''}}>Senior</option>
                                            </select>
                                    ...
                                    <div class="col-3 col-md-3">
                                        ...
                                        <div class="col-md-12">
                                            <select name="categoria" id="categoria" class="form-control @error('categoria') is-invalid @enderror" required>
                                                <option value="">Selecionar</option>
                                                <option value="CLT" {{ $vaga->categoria == 'CLT' ? 'selected' : ''}}>CLT</option>
                                                <option value="PJ" {{ $vaga->categoria == 'PJ' ? 'selected' : ''}}>Pessoa Juridica</option>
                                                <option value="Freelancer" {{ $vaga->categoria == 'Freelancer' ? 'selected' : ''}}>Freelancer</option>
                                            </select>
                                    ...
                                    <div class="col-3 col-md-3">
                                        ...
                                        <div class="col-md-12">
                                            <select name="regime" id="regime" class="form-control @error('regime') is-invalid @enderror" required>
                                                <option value="">Selecionar</option>
                                                <option value="presencial" {{ $vaga->regime == 'presencial' ? 'selected' : ''}}>Presencial</option>
                                                <option value="remoto" {{ $vaga->regime == 'remoto' ? 'selected' : ''}}>Remoto</option>
                                            </select>
                                    ...
                                    <div class="col-3 col-md-3">
                                        ...
                                        <div class="col-md-12">
                                            <input id="salario" type="text" class="form-control @error('salario') is-invalid @enderror" name="salario" value="{{ $vaga->salario }}" required autocomplete="salario" autofocus>
                                ...
                                <div class="form-group row">
                                    <div class="col-12 col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="descricao" rows="5" cols="40" class="form-control tinymce-editor">{!! $vaga->descricao !!}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="is_paused" value="1" id="vaga_pausada" @if( $vaga->is_paused == 1) checked @endif>
...
<script type="text/javascript">
    ...
    var selected_tags = [];
    @foreach($vaga->tags as $tags)
        selected_tags.push("{{$tags->id}}");
    @endforeach
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            createTags(suggestions, selected_tags);
        },
    });

    function createTags(data, selected){
        ...
        for(i = 0; i < selected.length; i++){
            amsifySuggestags.addTag(selected[i])
        }
