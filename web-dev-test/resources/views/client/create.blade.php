        ...
        <div class="box-body">
            ...
            {{ csrf_field() }}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <strong>CPF:</strong>
                        {!! Form::text('cpf', null, array('id' => 'cpf', 'placeholder' => 'Ex.: 123.456.789-01','class' => 'form-control cpf')) !!}
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <strong>Email:</strong>
                        {!! Form::text('email', null, array('placeholder' => 'Ex.:irineu@mail.com','class' => 'form-control')) !!}
                    </div>
                </div>
                <div class="col-md-12">
