...
@section('template_title', 'Novo Produto')
            ...
            <legend class="font-small form-control text-center"><i class="fas fa-clipboard-list"></i> Dados do Produto</legend>
                <div class="row form-group">
                    <div class="col-12 col-md-4 py-3">
                        ...
                        <input type="text" id="nome" name="nome" value="{{old('nome')}}" placeholder="Informe o nome completo" class="form-control @error('nome') is-invalid @enderror">
                        @error('nome')
                    ...
                    <div class="col-12 col-md-4 py-3">
                        ...
                        <input type="number" id="valor" name="valor" value="{{old('valor')}}" step="0.01" min="1" max="250" placeholder="Informe o valor" class="form-control quantity money2 @error('valor') is-invalid @enderror">
                        @error('valor')
                            <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    </div>
                    <div class="col-12 col-md-4 py-3">
                        ...
                        <input type="text" id="cod_barras" name="cod_barras" value="{{old('cod_barras')}}" placeholder="Informe o cod_barras" minlength="13" maxlength="13" class="form-control @error('cod_barras') is-invalid @enderror">
                        @error('cod_barras')
                            <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    </div>
